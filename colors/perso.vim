...
if &background == "light"
  ...
  hi LineNr	guibg=NONE	guifg=#969696	gui=NONE
...
if &background == "light"
  hi Comment	guibg=NONE	guifg=#FF9A0F   gui=NONE
  hi Constant	guibg=NONE	guifg=#007D03   gui=NONE
  hi Special	guibg=NONE	guifg=#000080	gui=NONE
  hi Identifier	guibg=NONE	guifg=#009B79   gui=NONE
  hi Statement	guibg=NONE	guifg=#666EDE   gui=bold
